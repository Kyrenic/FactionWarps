...
class FactionWarpOpenCommand(private val plugin: FactionWarps) : CommandExecutor, TabCompleter {
    override fun onCommand(sender: CommandSender, command: Command, label: String, args: Array<out String>): Boolean {
        ...
        if (!sender.hasPermission("fw.warp.open")) {
        ...
        warpService.saveWarp(warp.copy(accessible = true))
        sender.sendMessage("${ChatColor.GREEN}${plugin.language["WarpOpened", warpName]}")
        return true
    }
